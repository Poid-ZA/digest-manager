...
export const defaultFeeds = [
  ...
  { id: "feed-nvd", name: "NIST CVE Feed", url: NVD_API_URL, topic: "Cybersecurity", weight: 6, active: true, last_fetched: null, article_count: 0 },
];
...
export function summarizeDigestResult({
  ...
  const run = {
    ...
    preview: buildPreview(selectedArticles, config, fetchedAt),
